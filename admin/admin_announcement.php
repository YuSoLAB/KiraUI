    ...
    <div class="section">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <textarea id="announcement_content" name="announcement_content" rows="8" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-family: Consolas, Monaco, monospace; font-size: 14px; resize: vertical;"><?php echo htmlspecialchars($announcementConfig['content']); ?></textarea>
