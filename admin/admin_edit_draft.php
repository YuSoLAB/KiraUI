        ...
        <?php else: ?>
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea id="content" name="content" rows="15" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-family: Consolas, Monaco, monospace; font-size: 14px; resize: vertical;"><?php echo htmlspecialchars($currentArticle['content'] ?? ''); ?></textarea>
